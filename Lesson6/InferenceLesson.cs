...
internal sealed class InferenceLesson
{
    ...
    public static InferenceLesson Create(IReadOnlyList<string> selectedSentences, string? startSeed = null)
    {
